...
const settingsSchema = z.object({
  ...
  financeDefaults: z.object({ monthlyDueAmount: z.coerce.number().int().positive().max(999_999_999), roadEntryDueAmount: z.coerce.number().int().positive().max(999_999_999), monthlyDueDay: z.coerce.number().int().min(1).max(31), roadEntryAutomationEnabled: z.boolean() }),
