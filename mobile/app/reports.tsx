...
export default function Reports() {
  ...
  const query = useQuery({ queryKey: ["report", range.dateFrom, range.dateTo], queryFn: () => getReport(periodKey), enabled: Boolean(role) });
