...
export default function NewInformation() {
  ...
  async function submit(values: Values) {
    ...
    try {
      ...
      if (permission.status !== "granted") throw new Error("Izin lokasi diperlukan untuk mengirim informasi lapangan.");
