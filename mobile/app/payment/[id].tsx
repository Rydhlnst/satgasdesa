...
export default function PaymentForm() {
  const params = useLocalSearchParams<{ id?: string | string[] }>(); const dueId = routeParam(params.id); const { role } = useAuth(); const router = useRouter(); const [saving, setSaving] = useState(false); const [paymentId] = useState(createClientId); const [evidence, setEvidence] = useState<ImagePicker.ImagePickerAsset | null>(null);
