...
export default function NewBusinessActor() {
  ...
  const form = useForm<Values>({ resolver: zodResolver(schema), defaultValues: { actorType: "COMPANY" } });
  if (!role) return null;
