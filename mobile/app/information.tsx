...
export default function Information() {
  const { role, session } = useAuth(); const router = useRouter(); const [tab, setTab] = useState(0); const [statusTab, setStatusTab] = useState(0); const [queryText, setQueryText] = useState(""); const [reportedDate, setReportedDate] = useState(""); const [reportedDateError, setReportedDateError] = useState("");
