...
export async function GET(request: Request) {
  return withMobileSession(request, async () => {
    try {
      ...
      const result = await getDuePaymentsPage({ blockId: params.get("blockId") || undefined, periodKey: params.get("periodKey") || undefined, dateFrom: params.get("dateFrom") || undefined, dateTo: params.get("dateTo") || undefined, query: params.get("query") || undefined, page: params.get("page") || undefined, pageSize: params.get("pageSize") || undefined });
