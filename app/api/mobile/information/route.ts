...
export async function GET(request: Request) {
  ...
  try {
    ...
    return Response.json(await getDailyInformationPage({ query: params.get("query") || undefined, blockId: params.get("blockId") || undefined, category: params.get("category") || undefined, priority: params.get("priority") || undefined, status: params.get("status") || undefined, reportedDate: params.get("reportedDate") || undefined, mine: params.get("mine") || undefined, page: params.get("page") || undefined, pageSize: params.get("pageSize") || undefined }));
