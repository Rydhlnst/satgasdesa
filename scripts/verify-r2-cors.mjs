...
const origins = (process.env.STORAGE_CORS_ORIGINS ?? "http://localhost:3000,https://satgas.beres.io,https://satgasimage.beres.io").split(",").map((origin) => origin.trim()).filter(Boolean);
