...
const permissions = [
  ...
  "DUES_MANAGE", "PAYMENT_CREATE", "PAYMENT_CONFIRM", "PAYMENT_FIELD_VERIFY", "FINANCE_READ", "FINANCE_CREATE", "FINANCE_APPROVE", "FINANCE_CATEGORY_MANAGE", "BUDGET_READ",
...
const rolePermissions = {
  ...
  BENDAHARA: [
    ...
    "DUES_MANAGE", "PAYMENT_CREATE", "PAYMENT_CONFIRM", "FINANCE_READ", "FINANCE_CREATE", "FINANCE_CATEGORY_MANAGE", "BUDGET_READ",
  ...
  PETUGAS_LAPANGAN: [
    "BLOCK_READ", "BLOCK_CREATE", "BLOCK_UPDATE", "FIELD_ASSIGNMENT_MANAGE", "BUSINESS_ACTOR_READ", "BUSINESS_ACTOR_MANAGE", "WORKER_READ", "FIELD_TASK_READ", "FIELD_TASK_MANAGE", "EXCAVATOR_READ", "EXCAVATOR_MANAGE", "INSPECTION_READ", "INSPECTION_CREATE", "DAILY_INFO_READ",
    "DAILY_INFO_CREATE", "DAILY_INFO_UPDATE", "DUES_READ", "PAYMENT_FIELD_VERIFY",
  ],
  PENGUSAHA: ["BLOCK_READ", "BUSINESS_ACTOR_READ", "EXCAVATOR_READ", "FIELD_TASK_READ", "INSPECTION_READ", "DAILY_INFO_READ", "DUES_READ"],
};
